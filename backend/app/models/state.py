...
class RagChunk(TypedDict):
    ...
    file_type: str
    image_path: Optional[str]
    image_explanation: Optional[str]
...
class AgentState(TypedDict):
    ...
    rag_service: Any                                # In-memory service for post-syllabus retrieval
    topic_retrieval_debug: Dict[str, Any]           # Topic-wise retrieval diagnostics
